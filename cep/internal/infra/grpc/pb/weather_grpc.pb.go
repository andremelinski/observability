...
type WeatherService_GetLocationTemperatureClient interface {
	...
	Recv() (*WeatherLocationResponse, error)
	grpc.ClientStream
}
...
func (x *weatherServiceGetLocationTemperatureClient) Recv() (*WeatherLocationResponse, error) {
	m := new(WeatherLocationResponse)
...
type WeatherService_GetLocationTemperatureServer interface {
	Send(*WeatherLocationResponse) error
...
func (x *weatherServiceGetLocationTemperatureServer) Send(m *WeatherLocationResponse) error {
