...
func (x *WeatherLocationResponse) Reset() {
	*x = WeatherLocationResponse{}
...
func (x *WeatherLocationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WeatherLocationResponse) ProtoMessage() {}

func (x *WeatherLocationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_weather_proto_msgTypes[0]
...
// Deprecated: Use WeatherLocationResponse.ProtoReflect.Descriptor instead.
func (*WeatherLocationResponse) Descriptor() ([]byte, []int) {
	return file_proto_weather_proto_rawDescGZIP(), []int{0}
}

func (x *WeatherLocationResponse) GetTemp_C() float32 {
	if x != nil {
		return x.Temp_C
	}
	return 0
...
func (x *WeatherLocationResponse) GetTemp_F() float32 {
	if x != nil {
		return x.Temp_F
	}
	return 0
...
func (x *WeatherLocationResponse) GetTemp_K() float32 {
	if x != nil {
		return x.Temp_K
	}
	return 0
...
var file_proto_weather_proto_rawDesc = []byte{
	...
	,
...
var file_proto_weather_proto_goTypes = []interface{}{
	(*WeatherLocationResponse)(nil), // 0: pb.WeatherLocationResponse
...
var file_proto_weather_proto_depIdxs = []int32{
	...
	0, // 1: pb.WeatherService.GetLocationTemperature:output_type -> pb.WeatherLocationResponse
...
func file_proto_weather_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_weather_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WeatherLocationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
