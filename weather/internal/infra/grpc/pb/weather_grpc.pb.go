...
type WeatherServiceClient interface {
	GetLocationTemperature(ctx context.Context, in *WeatherLocationRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error)
}
...
func (c *weatherServiceClient) GetLocationTemperature(ctx context.Context, in *WeatherLocationRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	out := new(CreateOrderResponse)
	err := c.cc.Invoke(ctx, WeatherService_GetLocationTemperature_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	GetLocationTemperature(context.Context, *WeatherLocationRequest) (*CreateOrderResponse, error)
...
func (UnimplementedWeatherServiceServer) GetLocationTemperature(context.Context, *WeatherLocationRequest) (*CreateOrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLocationTemperature not implemented")
}
...
func _WeatherService_GetLocationTemperature_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WeatherLocationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeatherServiceServer).GetLocationTemperature(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WeatherService_GetLocationTemperature_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetLocationTemperature(ctx, req.(*WeatherLocationRequest))
	}
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetLocationTemperature",
